...
**YOU ARE IN: `gasclaw/polecats/toast/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/gasclaw/` (rig root) or other directories
...
**Your mail address:** `gasclaw/polecats/toast`
**Your rig:** gasclaw
**Your Witness:** `gasclaw/witness`
...
| Ask Witness for help | `gt mail send gasclaw/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`gasclaw/witness`) when:
...
```bash
gt mail send gasclaw/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
